...
```
npm install atropa-removeNodeByReference
```

The bleeding edge development version:

```
npm install git+https://github.com/matthewkastor/atropa-removeNodeByReference.git#master
```
...
This package lives at: [https://npmjs.org/package/atropa-removeNodeByReference](https://npmjs.org/package/atropa-removeNodeByReference)

Source code available at: [https://github.com/matthewkastor/atropa-removeNodeByReference/](https://github.com/matthewkastor/atropa-removeNodeByReference/)
...
```
var removeNodeByReference = require('atropa-removeNodeByReference').removeNodeByReference;
console.log(removeNodeByReference);
```

In the browser this module is attached to the global namespace `atropa`, which
 will be created if it does not exist.
 Include `./browser/atropa-removeNodeByReference_web.js` in your page and
 `atropa.removeNodeByReference` will be available in your page.
...
To run the browser tests open `browser/atropa-removeNodeByReference_tests.html` in your
...
If you alter the source in `src/atropa-removeNodeByReference.js` please run the
